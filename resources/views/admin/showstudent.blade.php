                                                        ...
                                                        <li>
                                                            <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">
                                                                    <form method="post" action="/admin/seacrh">
                                                                        @csrf
                                                                   <button type="submit" class="btn btn-primary ;color:white"> <em class="icon ni ni-search"></em></button>
                                                                </div>
                                                                
                                                                <input type="text" class="form-control" id="default-04" placeholder="Search by name" name="text">
                                                            </form>
                                                            </div>
                                                        </li>
                                                                ...
                                                                <a href="html/lms/instructor-details.html">
                                                                    <div class="user-card">
                                                                        <div class="user-avatar bg-primary">
                                                                            <span><img src="assets/uploads/{{$row->image}}"></span>
                                                                        </div>
                                                                        <div class="user-info">
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="{{route('deleteuser',['id'=>$row->id])}}"><em class="icon ni ni-eye"></em><span>Delete</span></a></li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="{{route('createformatteur')}}" method="POST" enctype="multipart/form-data" class="pt-2">
                        @csrf
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="first-name">Full Name</label>
                                    <input type="text" class="form-control" name="name" id="first-name" placeholder="full name">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
